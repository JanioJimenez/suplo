    ...
    $.ajax({
        ...
        success:function(data){
            ...
            data.forEach(element => {
                $('#selectCiudad, #selectCiudadFiltro').append(`
...
async function getType() {
    $.ajax({
        ...
        success:function(data){
            console.log(data);
            data.forEach(element => {
                $('#selectTipo, #selectTipoFiltro').append(`
                    ...
                    $('#MyGoods').append(`
                        <div  class="goods-child">
                            ...
                            <div class="goods">
                                ...
                                <button class="button-save" onclick="deleteGood(${element.id})">Eliminar</button>
...
function generateExcel() {
    let city = $( "#selectCiudadFiltro option:selected" ).val()
    let type = $( "#selectTipoFiltro option:selected" ).val()
    if (city !== "" && type !== "") {
        object = {
            city,
            type,  
        ...
        $('#search-error-generate').text('Faltan campos')   
        setTimeout(() => {
            $('#search-error-generate').text('')                    
        }, 2000);
    }
}
